...
const HomeHero = () => {
  return (
    <div className="wrapper relative">
      ...
      >
        <div className="flex flex-col text-center max-sm:px-2 sm:text-start">
          <div className="flex items-center justify-center gap-4 pb-3 md:justify-start">
          ...
          <p className="font mx-auto mb-6 max-w-80 font-medium sm:mx-0">
          ...
          <button className="relative mx-auto w-fit overflow-hidden rounded-[25px] bg-sonqu-orange-400 px-10 py-3 text-white transition-all duration-300 before:absolute before:left-[-100%] before:top-0 before:h-full before:w-full before:bg-white/20 before:transition-all before:duration-500 hover:-translate-y-1 hover:shadow-xl hover:before:left-[100%] sm:mx-0">
            CONOCE MÁS
          </button>
        </div>
      </div>
