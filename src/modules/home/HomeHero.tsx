import { BookText, Instagram, ShoppingBag, Youtube } from 'lucide-react'
        ...
        <div className="relative flex flex-col px-2 text-center sm:text-start">
          ...
          <div className="mb-6 flex items-center justify-center gap-4 text-black lg:justify-start">
            <a href="#" className="flex items-center gap-2 transition-colors">
              ...
              <span className="text-sm font-semibold">200 K</span>
            </a>
            <a href="#" className="flex items-center gap-2 transition-colors">
              <Instagram className="h-4 w-4" />
              <span className="text-sm font-semibold">19.9 K</span>
            </a>
            <a href="#" className="flex items-center gap-2 transition-colors">
              <svg
              ...
              <span className="text-sm font-semibold">609.6 K</span>
            </a>
          </div>
          <h1 className="mb-3 text-center font-monserrat text-[45px] font-extrabold uppercase leading-none text-[#1f1f1f] sm:text-[60px] lg:text-start lg:text-6xl xl:text-7xl">
            Las Mejores <span className="block"> Recetas</span>
          </h1>
          <h2 className="mb-8 text-center font-fingerPaint text-[25px] font-semibold uppercase leading-none text-[#717172] sm:text-[30px] lg:text-start xl:text-[40px]">
            En un solo lugar
          </h2>
          <p className="mx-auto mb-8 max-w-[500px] px-6 text-center font-monserrat text-base font-normal text-black sm:mx-0 md:px-0 lg:text-start lg:text-[20px]">
          ...
          <div className="flex flex-col flex-wrap gap-2.5 px-14 md:flex-row md:gap-4 md:px-0">
            <Link
              href="/search"
              className="flex items-center justify-center gap-2 rounded-xl bg-gradient-to-r from-[#ff3d4d] to-pink-600 px-8 py-3 font-semibold text-white shadow-lg transition hover:bg-red-700 hover:shadow-red-600/30"
            >
