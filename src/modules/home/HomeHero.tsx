    ...
    <div className="wrapper relative">
      ...
      >
        <div className="flex flex-col text-center sm:text-start">
          <div className="flex items-center justify-center gap-4 pb-3 text-white md:justify-start">
          ...
          <h1 className="font-fingerPaint text-6xl uppercase text-white sm:text-7xl">
            Las Mejores <span className="block"> Recetas</span>
          </h1>
          <h2 className="mb-4 font-fingerPaint text-5xl uppercase text-sonqu-orange-400">
            En un solo lugar
          </h2>
          <p className="font mx-auto mb-3 max-w-96 font-medium text-white sm:mx-0">
          ...
          <button className="mx-auto w-fit rounded-xl bg-gradient-to-r from-sonqu-orange-400 to-[#e05f09] px-10 py-3 text-white sm:mx-0">
            CONOCE MÁS
          </button>
        </div>
      </div>
