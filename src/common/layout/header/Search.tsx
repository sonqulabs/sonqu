  ...
  return (
    <Link
      ...
      className={cn(
        ...
        'flex h-0 items-center justify-between rounded-md bg-white px-2.5 py-4 text-xs text-gray-500/80 hover:bg-white/80'
      )}
    >
      <SearchIcon className="h-4 w-4 sm:mr-2" aria-hidden="true" />
      <span className="mr-2 h-5 border-r border-gray-300"></span>
